...
CFLAGS =  -Wall -g -Wno-unused-parameter -Wformat -Wformat-security -Wimplicit -Wparentheses -Wshadow # generic
...
GM_OBJ = $(ObjDir)/gm/palmapper/GenomeMaps.o \
	...
	$(ObjDir)/gm/palmapper/FileReporter.o \
...
PM_OBJ = $(ObjDir)/pm/palmapper/GenomeMaps.o \
	...
	$(ObjDir)/pm/palmapper/FileReporter.o \
