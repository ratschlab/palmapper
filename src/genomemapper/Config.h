...
public:
	...
	static int const NUM_TOP_ALIGNMENTS = 10 ;
	...
	int FILTER_BY_MAX_MISMATCHES;
	int FILTER_BY_MAX_GAPS;
	int FILTER_BY_SPLICE_SITES;
	int FILTER_BY_SPLICE_SITES_REGION;
	int FILTER_BY_SPLICE_SITES_EDIT_MIN;
